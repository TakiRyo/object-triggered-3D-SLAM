...
def generate_launch_description():
    ...
    lidar_cluster = Node(
        ...
        output='screen',
        remappings=[
            ('/object_clusters', '/lidar_object_clusters'),
        ],
        parameters=[{
            'gap_threshold': 0.2,
    ...
    # Object Map Filter (The Gatekeeper)
    # Subscribes to: /object_clusters AND /virtual_scan
    # Publishes: /final_dynamic_objects (Only true new objects)
    object_filter = Node(
        package='lidar_detection',
        ...
        output='screen',
        remappings=[
            ('/filtered_objects', 'object_clusters'),
        ],
        parameters=[{
