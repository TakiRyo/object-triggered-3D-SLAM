...
color_path = os.path.join(base_dir, "color/color_0001.png")
depth_path = os.path.join(base_dir, "depth/depth_0001.png")
...
depth_scale = 0.01   # if depth saved as float in meters 0.01
